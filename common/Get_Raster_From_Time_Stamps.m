...
%
% Time stamps have to be in the workspace, and window defines the bin of the raster in s.
%
%       raster = Get_Raster_From_Time_Stamps(window,initial_time,final_time)
%
...
% Define raster size
raster = zeros(n_cells,max_time,'logical');
